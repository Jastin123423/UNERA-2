...
export const CreateProductModal: React.FC<CreateProductModalProps> = ({ currentUser, onClose, onCreate }) => {
    ...
    const handleSubmit = () => {
        if (!title || !price || !category || !imagePreview || !country) {
                ...
                <div className="p-6 overflow-y-auto space-y-5 scrollbar-hide">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input type="text" className="w-full bg-[#3A3B3C] border border-[#3E4042] rounded-xl p-3.5 text-[#E4E6EB] outline-none focus:border-[#1877F2] transition-all" value={title} onChange={e => setTitle(e.target.value)} placeholder="What are you selling?" />
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-[#B0B3B8] font-bold mb-1.5 text-xs uppercase tracking-widest">Price</label>
                                <input type="number" className="w-full bg-[#3A3B3C] border border-[#3E4042] rounded-xl p-3.5 text-[#E4E6EB] outline-none focus:border-[#1877F2] transition-all" value={price} onChange={e => setPrice(e.target.value)} placeholder="0.00" />
                            </div>
                            <div>
                                <label className="block text-[#B0B3B8] font-bold mb-1.5 text-xs uppercase tracking-widest">Category</label>
                                <select className="w-full bg-[#3A3B3C] border border-[#3E4042] rounded-xl p-3.5 text-[#E4E6EB] outline-none focus:border-[#1877F2] transition-all appearance-none" value={category} onChange={e => setCategory(e.target.value)}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select className="w-full bg-[#3A3B3C] border border-[#3E4042] rounded-xl p-3.5 text-[#E4E6EB] outline-none focus:border-[#1877F2] transition-all appearance-none" value={country} onChange={e => setCountry(e.target.value)}>
                        ...
                        <div>
                            ...
                            <input type="text" className="w-full bg-[#3A3B3C] border border-[#3E4042] rounded-xl p-3.5 text-[#E4E6EB] outline-none focus:border-[#1877F2] transition-all" value={address} onChange={e => setAddress(e.target.value)} placeholder="e.g. Arusha" />
                        </div>
                    </div>

                    <div>
                        <label className="block text-[#B0B3B8] font-bold mb-1.5 text-xs uppercase tracking-widest">Description</label>
                        <textarea className="w-full bg-[#3A3B3C] border border-[#3E4042] rounded-xl p-3.5 text-[#E4E6EB] outline-none focus:border-[#1877F2] h-24 resize-none transition-all" value={description} onChange={e => setDescription(e.target.value)} placeholder="Describe your item..." />
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-[#B0B3B8] font-bold mb-1.5 text-xs uppercase tracking-widest">Phone Number</label>
                            <input type="tel" className="w-full bg-[#3A3B3C] border border-[#3E4042] rounded-xl p-3.5 text-[#E4E6EB] outline-none focus:border-[#1877F2] transition-all" value={phone} onChange={e => setPhone(e.target.value)} placeholder="+255..." />
                        </div>
                        <div>
                            <label className="block text-[#B0B3B8] font-bold mb-1.5 text-xs uppercase tracking-widest">Quantity</label>
                            <input type="number" className="w-full bg-[#3A3B3C] border border-[#3E4042] rounded-xl p-3.5 text-[#E4E6EB] outline-none focus:border-[#1877F2] transition-all" value={quantity} onChange={e => setQuantity(e.target.value)} min="1" />
                        </div>
                    </div>
