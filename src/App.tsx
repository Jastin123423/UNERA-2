...
export default function App() {
    ...
    return (
        <div className="bg-[#18191A] min-h-screen text-[#E4E6EB] font-sans">
            ...
            {showCreateStory && currentUser && <CreateStoryModal currentUser={currentUser} onClose={() => setShowCreateStory(false)} onCreate={(story) => { setStories([{ ...story as Story, id: Date.now(), userId: currentUser.id, createdAt: Date.now(), user: currentUser, type: story.type || 'image' }, ...stories]); setShowCreateStory(false); }} />}
